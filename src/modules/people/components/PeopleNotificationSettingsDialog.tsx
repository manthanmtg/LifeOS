...
export default function PeopleNotificationSettingsDialog({
  ...
  return (
    <Dialog
      ...
      backdropClassName="bg-zinc-950/75 backdrop-blur-sm"
      className="max-w-4xl max-h-[90dvh] rounded-b-none rounded-t-2xl border-zinc-800 bg-zinc-950 md:rounded-2xl flex flex-col"
    >
