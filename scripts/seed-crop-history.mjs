...
async function main() {
    ...
    crops: [
      {
        ...
        constants: [
          {
            id: "UNDRIED_TO_BAG_CONVERT",
            name: "UNDRIED_TO_BAG_CONVERT",
            value: 120,
          },
        ],
        calculatedFields: [
          ...
          },
          {
            id: "avg_ot",
            name: "Average OT",
            formula: "WEIGHTED_AVG(ot, undried)",
            format: "percentage",
          },
          {
            id: "approx_bags",
            name: "Approx Bags",
            formula: "ROUND(SUM(undried) / UNDRIED_TO_BAG_CONVERT, 1)",
            format: "number",
          },
          {
            id: "approx_income",
            name: "Approx Income",
            formula: "approx_bags * avg_price",
            format: "currency",
          },
        ],
        analyticsConfig: {
          yieldFieldId: "undried",
          revenueFieldId: "approx_income",
        },
      },
    ],
  };
  ...
  cropSettings.crops.push({
    ...
    calculatedFields: [
      ...
      },
      {
        id: "total_amount",
        name: "Total Amount",
        formula: "total_weight * avg_price",
        format: "currency",
      },
    ],
  ...
  const deleted = await db
    .collection("content")
    .deleteMany({ module_type: "crop_history" });
