            ...
            <div className="flex flex-col md:flex-row md:items-start justify-between gap-3">
              <div>
                ...
                <div className="flex flex-wrap justify-center md:justify-start items-center gap-2">
                  <span className="text-xs font-bold uppercase tracking-wider px-2.5 py-1 rounded-lg bg-zinc-950/40 text-zinc-400 border border-zinc-800/50">
                    {relationship}
                  </span>
                  {company && (
                    <span className="text-xs font-medium text-zinc-500 flex items-center gap-1 bg-zinc-950/40 px-2.5 py-1 rounded-lg border border-zinc-800/40">
                    ...
                    <span className="text-xs font-semibold text-zinc-300">
                      ...
                      {birthdayDetails?.ageTurning !== null &&
                        birthdayDetails?.ageTurning !== undefined && (
                          <span className="ml-1.5 rounded-md border border-zinc-700/50 bg-zinc-800 px-1.5 py-0.5 text-xs font-bold text-zinc-400">
        ...
        <div className="lg:col-span-1 space-y-4">
          <div className="bg-zinc-900/40 border border-zinc-800/40 rounded-2xl p-5">
            ...
            <div className="space-y-5">
              {notes && (
                <div>
                  <span className="text-xs font-bold uppercase tracking-wider text-zinc-600 mb-2 block">
                    Notes
                  </span>
              ...
              {(interests || []).length > 0 && (
                <div>
                  <span className="text-xs font-bold uppercase tracking-wider text-zinc-600 mb-2 block flex items-center gap-1.5">
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {interests?.map((i) => (
                      <span
                        key={i}
                        className="px-2.5 py-1 rounded-lg bg-zinc-900 border border-zinc-800 text-xs font-medium text-zinc-400"
                      >
                        {i}
                      </span>
                    ))}
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {tags?.map((t) => (
                      <span
                        key={t}
                        className="px-2.5 py-1 rounded-lg bg-accent/5 border border-accent/20 text-xs font-medium text-accent"
                      >
                        {t}
                      </span>
                    ))}
