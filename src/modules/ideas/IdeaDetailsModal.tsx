...
export default function IdeaDetailsModal({
  ...
  const timestampItems = useMemo(() => {
    ...
    return [
      {
        label: "Created",
        value: formatIdeaTimestamp(idea.created_at),
        icon: Calendar,
      },
      {
        label: "Updated",
        value: formatIdeaTimestamp(idea.updated_at),
        icon: Clock3,
      },
      {
        label: "Promoted",
        value: formatIdeaTimestamp(idea.payload.promoted_at),
        icon: Clock3,
      },
        ...
        <div className="fixed inset-0 z-[140]" dir="auto">
          ...
          <div className="absolute inset-0 flex items-end justify-center p-0 sm:p-4">
            ...
            >
              <div
                ...
                onTouchMove={(event) => {
                  ...
                  const delta = Math.max(
                    0,
                    (event.touches[0]?.clientY ?? 0) - touchStartY,
                  );
              ...
              >
                <span
                  className="h-1.5 w-14 rounded-full bg-zinc-700"
                  aria-hidden="true"
                />
              </div>
                ...
                <div className="min-w-0 space-y-3 text-start">
                  ...
                  <div className="space-y-1">
                    ...
                    <p id={descriptionId} className="text-sm text-zinc-400">
                      Full idea details including description, notes, tags, and
                      timeline metadata.
                    </p>
                  </div>
                </div>
