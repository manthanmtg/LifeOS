...
export default function ExpensesPublicView({
  items,
}: {
            ...
            >
              <span
                className={cn(
                  ...
                  CATEGORY_COLORS[cat] || "bg-zinc-500/15 text-zinc-400",
                )}
              >
                {cat}
              </span>
              ...
              <div className="flex items-center gap-2 mt-1">
                <span
                  className={cn(
                    ...
                    CATEGORY_COLORS[exp.payload.category] ||
