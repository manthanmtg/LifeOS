...
- Read `prompts/README.md` first. Its run contract applies to this optimizer.
- Read `AGENTS.md` and `README.md` to understand the current project architecture, commands, and conventions.
