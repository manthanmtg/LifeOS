...
export default function TodoModal({ todo, onClose, onSave }: TodoModalProps) {
  ...
  return (
    <Dialog
      ...
      containerClassName="items-end p-0 md:items-center md:justify-center md:p-4"
      backdropClassName="bg-zinc-950/80 backdrop-blur-md"
      className="w-full rounded-b-none rounded-t-[2.5rem] border-zinc-800/50 bg-zinc-950/80 backdrop-blur-2xl md:max-w-xl md:rounded-[3rem]"
    >
