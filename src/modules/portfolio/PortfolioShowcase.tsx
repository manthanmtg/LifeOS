...
function cleanSocialLinks(profile: PortfolioProfile) {
  return (profile.social_links || []).filter(
              ...
              {skills.map((skill, i) => (
                ...
                >
                  <div className="relative z-10">
                    <p className="text-zinc-200 font-medium tracking-tight group-hover:text-zinc-50 transition-colors uppercase text-xs tracking-[0.05em]">
                      {skill}
                    </p>
        ...
        >
          ...
          <div className="relative z-10 space-y-6">
            ...
            <p className="text-zinc-400 text-base md:text-lg max-w-xl mx-auto font-light">
              If you&apos;re looking for a focused builder to join your team or
