...
Find **one untested or undertested file** in the LifeOS codebase and add meaningful test coverage for it. This is a growth prompt — you are expanding the safety net, one file at a time.
...
- Prioritize in this order:
  ...
  3. `src/modules/*/AdminView.tsx` components (complex UI logic)
...
- Keep local fixtures small and explicit within the test file or a nearby '__tests__/fixtures' directory if needed.
