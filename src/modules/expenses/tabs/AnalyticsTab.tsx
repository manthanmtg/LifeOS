        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2 px-4 py-2 bg-zinc-950 rounded-2xl border border-zinc-800 shadow-inner">
            ...
            <select
              ...
              className="bg-transparent text-sm font-black text-zinc-50 focus:outline-none cursor-pointer tracking-tighter"
            >
        ...
        {activeTab === "overview" && (
          ...
          >
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-[3rem] p-8 shadow-2xl flex flex-col relative overflow-hidden">
              <h3 className="text-xl font-black text-zinc-50 tracking-tight mb-2 flex items-center gap-2">
        ...
        {activeTab === "tags" && (
          ...
          >
            <div className="flex items-center justify-between mb-10">
              <div>
                <h3 className="text-2xl font-black text-zinc-50 tracking-tight flex items-center gap-3">
