...
const widgetImports: Record<string, ComponentType> = {
  expenses: dynamic(() => import("@/modules/expenses/Widget"), {
    ssr: false,
  ...
  calculators: dynamic(() => import("@/modules/calculators/Widget"), {
    ssr: false,
    loading: () => <WidgetSkeleton />,
  }),
  blog: dynamic(() => import("@/modules/blog/Widget"), {
    ssr: false,
    loading: () => <WidgetSkeleton />,
  }),
  portfolio: dynamic(() => import("@/modules/portfolio/Widget"), {
    ssr: false,
    loading: () => <WidgetSkeleton />,
  }),
  reading: dynamic(() => import("@/modules/reading/Widget"), {
    ssr: false,
    loading: () => <WidgetSkeleton />,
  }),
  bookshelf: dynamic(() => import("@/modules/bookshelf/Widget"), {
    ssr: false,
    loading: () => <WidgetSkeleton />,
  }),
  ideas: dynamic(() => import("@/modules/ideas/Widget"), {
    ssr: false,
    loading: () => <WidgetSkeleton />,
  }),
  snippets: dynamic(() => import("@/modules/snippets/Widget"), {
    ssr: false,
    loading: () => <WidgetSkeleton />,
  }),
  habits: dynamic(() => import("@/modules/habits/Widget"), {
    ssr: false,
    loading: () => <WidgetSkeleton />,
  }),
  analytics: dynamic(() => import("@/modules/analytics/Widget"), {
    ssr: false,
    loading: () => <WidgetSkeleton />,
  }),
  compass: dynamic(() => import("@/modules/compass/Widget"), {
    ssr: false,
    loading: () => <WidgetSkeleton />,
  }),
  "rain-tracker": dynamic(() => import("@/modules/rain-tracker/Widget"), {
    ssr: false,
    loading: () => <WidgetSkeleton />,
  }),
  todo: dynamic(() => import("@/modules/todo/Widget"), {
    ssr: false,
    loading: () => <WidgetSkeleton />,
  }),
  ...
  people: dynamic(() => import("@/modules/people/Widget"), {
    ssr: false,
    loading: () => <WidgetSkeleton />,
  }),
  vehicle: dynamic(() => import("@/modules/vehicle/Widget"), {
    ssr: false,
    loading: () => <WidgetSkeleton />,
  }),
  maintenance: dynamic(() => import("@/modules/maintenance/Widget"), {
    ssr: false,
    loading: () => <WidgetSkeleton />,
  }),
  health: dynamic(() => import("@/modules/health/Widget"), {
    ssr: false,
    loading: () => <WidgetSkeleton />,
  }),
  whiteboard: dynamic(() => import("@/modules/whiteboard/Widget"), {
    ssr: false,
    loading: () => <WidgetSkeleton />,
  }),
  slides: dynamic(() => import("@/modules/slides/Widget"), {
    ssr: false,
    loading: () => <WidgetSkeleton />,
  }),
