    ...
    >
      ...
      <div className="mt-4 relative z-10">
        <div className="flex items-center justify-between text-[10px] mb-1.5 px-0.5">
          <span className="text-zinc-500 font-bold uppercase tracking-tighter">Principal Paid</span>
          <span className={cn(
        ...
        <div className="h-1.5 rounded-full bg-zinc-950/80 border border-white/[0.03] overflow-hidden">
          <div
            className={cn(
              ...
              isSelected ? "bg-accent shadow-accent/40" : "bg-zinc-700 shadow-transparent"
            )}
