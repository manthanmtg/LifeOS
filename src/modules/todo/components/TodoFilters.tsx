...
export default function TodoFilters({ 
  ...
  const filters: Array<{ 
    ...
    { id: "todo", label: "Active", icon: Circle, color: "text-zinc-500", activeColor: "text-accent" },
    { id: "today", label: "Today", icon: Clock, color: "text-zinc-500", activeColor: "text-success" },
    { id: "overdue", label: "Overdue", icon: Calendar, color: "text-zinc-500", activeColor: "text-danger" },
    { id: "high", label: "Critical", icon: Flag, color: "text-zinc-500", activeColor: "text-warning" },
    { id: "done", label: "Done", icon: CheckCircle2, color: "text-zinc-500", activeColor: "text-zinc-300" },
  ];
        ...
        {filters.map((f) => (
          ...
          >
            <f.icon className={cn(
              ...
              activeFilter === f.id ? f.activeColor : "text-zinc-600 group-hover:text-zinc-400"
            )} />
