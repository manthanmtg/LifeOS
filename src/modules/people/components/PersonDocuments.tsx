      ...
      <div className="bg-zinc-900/40 border border-zinc-800/40 rounded-2xl p-5">
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            ...
            className="flex items-center gap-1 px-2.5 py-1.5 bg-accent/10 text-accent text-xs font-bold uppercase tracking-wider rounded-lg border border-accent/20 hover:bg-accent/20 transition-all active:scale-95"
          >
